...
import com.pratishthakapoor.gomovie.di.component.DaggerActivityComponent;
...
public class BaseActivity extends AppCompatActivity implements MvpView, BaseFragment.Callback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((GomovieApplication) getApplication()).getApplicationComponent())
                .build();
    }

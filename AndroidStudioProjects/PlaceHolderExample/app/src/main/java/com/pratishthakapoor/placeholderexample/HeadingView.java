...
@Parent
@SingleTop
@Layout(R.layout.feed_head)
public class HeadingView {

    @View(R.id.head_text)
    private TextView headingTxt;

    @View(R.id.toogle_image)
    ...
    private void onResolved() {
        toggleIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_expand_more_black));
        headingTxt.setText(mHeading);
    }

    @Expand
    private void onExpand(){
        toggleIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_expand_less_black));
    }
